...
class ScoreModel(nn.Module):
  def __init__(self, input_dim, logistic_dim1, logistic_dim2, logistic_dim3, score_dim1, score_dim2):
    super(ScoreModel, self).__init__()
    self.logisticMode = True
    self.useInputDropout = False


    self.log1 = nn.Sequential(nn.Linear(input_dim, logistic_dim1), nn.Sigmoid(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim1, logistic_dim2), nn.Sigmoid(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim2, logistic_dim3), nn.Sigmoid(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim3, logistic_dim3), nn.Sigmoid(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim3, logistic_dim3), nn.Sigmoid())  
    
    self.log2 = nn.Sequential(nn.Linear(input_dim, logistic_dim1), nn.ReLU(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim1, logistic_dim2), nn.Sigmoid(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim2, logistic_dim3), nn.ReLU(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim3, logistic_dim3), nn.Sigmoid(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim3, logistic_dim3), nn.ReLU()) 
    
    self.log3 = nn.Sequential(nn.Linear(input_dim, logistic_dim1), nn.Tanh(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim1, logistic_dim2), nn.Tanh(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim2, logistic_dim3), nn.Tanh(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim3, logistic_dim3), nn.Tanh(), nn.Dropout(0.5),
                              nn.Linear(logistic_dim3, logistic_dim3), nn.Tanh())     
